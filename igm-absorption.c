/*! \file igm_absorption.c
 *  \brief Function definition for IGM absorption following Inoue et al 2014.
 *
...
void print_igm_absorption(double *lambda, int n_lambda, double z)
{
  ...
  FILE *fp;
  char fname[200];
  sprintf(fname,"igm_absorption.%6.5f.txt",z);
